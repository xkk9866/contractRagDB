...
\Description{A three-part comparison showing an evidence contract, a
space of retrieval-augmented execution plans, and the difference between
point-estimate selection and statistically certified selection.}
\label{fig:example}
\end{figure*}
